    ...
    return (
        <>
            {loading ? (
                ...
                <div className="bg-gray-100 min-h-screen flex justify-center items-start py-8 mt-20">
                    {provider ? (
                        <div className="max-w-5xl w-full px-4 sm:px-6 lg:px-8">
                            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                <div className="md:flex">
                                        ...
                                        <div className="md:w-1/4 bg-gray-50 shadow-2xl p-4 flex justify-center items-center">
                                            <img
                                    ...
                                    <div className="md:flex-1 p-6">
                                            ...
                                            <div className="flex 	">
                                                ...
                                                {provider.expertise_area ? (
                                                    provider.expertise_area.map((item, index) => (
                                                        <p
                                                            className="text-gray-900 font-body m-2 border-[2px] bg-green-100 p-1 rounded border-black"
                                                            key={index}>
                                                            {item}
                                                        </p>
                                                    ))
                                        ...
                                        <div className="flex space-x-4">
                                            <button
                                                ...
                                                className="bg-green-700 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md">
